...
`Orders` cədvəlindən sifarişlə bağlı lazımi sütunlar seçildi və `WHERE RequiredDate < ShippedDate` şərti ilə tələb olunan tarixdən gec göndərilmiş sifarişlər müəyyən edildi.
...
* `Orders` cədvəlündən sifarişlə bağlı lazımi sütunlar seçildi.
