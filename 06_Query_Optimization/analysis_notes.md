...
Bu dataset üzrə Correlated Subquery ilə yazılmış sorğunun icra müddəti 498 ms olmuşdur.
...
Bu sorğunun icra müddəti 119 ms olmuşdur.

### 📊 Performans müqayisəsi

| Yanaşma             | İcra müddəti |
| ------------------- | -----------: |
| Correlated Subquery |       498 ms |
| JOIN                |       119 ms |

Bu dataset üzrə JOIN yanaşması Correlated Subquery ilə müqayisədə təxminən 4.2 dəfə daha sürətli nəticə vermişdir.
...
Bu analizdə JOIN yanaşmasının **119 ms**, Correlated Subquery yanaşmasının isə **498 ms** nəticə göstərməsi JOIN-in bu dataset üzrə daha effektiv alternativ olduğunu göstərmişdir.
...
Aşağıdakı nəticədə Correlated Subquery yanaşmasının **498 ms** icra müddəti və sorğunun nəticəsi göstərilir.

![Correlated Subquery Performance](01_correlated_subquery.png)

### JOIN ilə optimallaşdırılmış sorğu

Aşağıdakı nəticədə JOIN yanaşmasının **119 ms** icra müddəti və sorğunun nəticəsi göstərilir.
...
Bu dataset üzrə Correlated Subquery ilə yazılmış sorğunun icra müddəti 498 ms, JOIN ilə yazılmış sorğunun icra müddəti isə 119 ms olmuşdur.

Nəticədə JOIN yanaşması təxminən 4.2 dəfə daha sürətli nəticə vermişdir.
